# ===== file: train_fund.py =====
"""
Krok 2 kaskady: pre-train autoencodera fund + trening fund_agent.

Tryby sektorow (--sector-mode):
  macro (DEFAULT): laduje macro_agent, pre-computuje sector_weights_by_t.
  equal: rowne wagi 1/n_sectors (ablation).

Modele: {outputs_dir}/models/fund/{algo}/

Uruchomienie:
  python train_fund.py --algo td3 --run-name td3_default --sector-mode macro --timesteps 75000
"""
